...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post prospects_url, params: { prospect: { chance: @prospect.chance, first_name: @prospect.first_name, last_name: @prospect.last_name, target: @prospect.target } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { chance: @prospect.chance, first_name: @prospect.first_name, last_name: @prospect.last_name, target: @prospect.target } }
